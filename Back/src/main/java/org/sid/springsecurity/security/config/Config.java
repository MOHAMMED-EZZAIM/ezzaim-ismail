...
public class Config extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/appartement/").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/appartement/").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/appartement/").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.POST, "/autre-url").hasAuthority("ADMIN")
